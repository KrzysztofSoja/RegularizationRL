...
from modificated_sb3.td3 import TD3
...
class DDPG(TD3):
    ...
    def __init__(
        ...
        super(DDPG, self).__init__(
            ...
            actor_gradient_penalty=actor_gradient_penalty,
            critic_gradient_penalty=critic_gradient_penalty,
            actor_gradient_penalty_k=actor_gradient_penalty_k,
            critic_gradient_penalty_k=critic_gradient_penalty_k,
