...
DROPOUT_RATE_ACTOR = [0]#[0, 0.2, 0.5]  # flout number from 0 to 1 or False
DROPOUT_RATE_CRITIC = [0]# [0, 0.2, 0.5]
DROPOUT_ONLY_ON_LAST_LAYER = [False] #[True, False]
...
GRADIENT_PENALTY_CRITIC = [0] # [0.1, 0.5, 1, 5, 10]
GRADIENT_PENALTY_CRITIC_K = [0] # [0, 1]
