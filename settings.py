...
MUJOCO = ["InvertedDoublePendulum-v2", "InvertedPendulum-v2"]
       #
       # ['HalfCheetah-v2',
       #   'Ant-v2',
       #   'Walker2d-v2',
...
DROPOUT_RATE_ACTOR = [0, 0.2, 0.5]  # flout number from 0 to 1 or False
DROPOUT_RATE_CRITIC = [0, 0.2, 0.5]
DROPOUT_ONLY_ON_LAST_LAYER = [True, False]
